...
const Dashboard = () => {
  ...
  let users = totalUsersContext.users;
  ...
  const topPosts = [
    { id: 1, title: 'Understanding React Hooks for Beginners', views: '1,200', author: 'Alice', date: '2025-07-28' },
    { id: 2, title: 'CSS Grid vs Flexbox: When to Use Which?', views: '980', author: 'Bob', date: '2025-07-29' },
    { id: 3, title: 'Optimizing Database Queries in SQL', views: '750', author: 'Charlie', date: '2025-07-27' },
    { id: 4, title: 'The Future of AI in Web Development', views: '610', author: 'Diana', date: '2025-07-30' },
    { id: 5, title: 'Getting Started with Node.js APIs', views: '550', author: 'Ethan', date: '2025-07-26' },
  ];

  const latestActivities = [
    { id: 1, user: 'User123', action: 'created new post', item: '"My First JavaScript Project"', time: '5 mins ago' },
    { id: 2, user: 'User456', action: 'commented on', item: '"React Performance Tips"', time: '15 mins ago' },
    { id: 3, user: 'User789', action: 'updated profile', item: '', time: '30 mins ago' },
    { id: 4, user: 'User123', action: 'uploaded image', item: '"/images/profile.jpg"', time: '1 hour ago' },
    { id: 5, user: 'UserABC', action: 'published post', item: '"Understanding Async/Await"', time: '2 hours ago' },
  ];
        ...
        {stats.map(stat => (
          <div key={stat.id} className={`stat-v3-card ${stat.colorAccent}`}>
            ...
            <div className="stat-v3-info">
              ...
              <span className={`stat-v3-change ${stat.trend === 'up' ? 'stat-v3-change-up' : 'stat-v3-change-down'}`}>
          ...
          <ul className="activity-feed">
            {latestActivities.map(activity => (
              <li key={activity.id} className="activity-feed-item">
                ...
                {activity.item && <span className="activity-item-name">{activity.item}</span>}
